 ...
 */
final class Version20231006121309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN last_connect DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO films (id, title, poster, country, realease_at, plot, price, age) SELECT id, title, poster, country, realease_at, plot, price, age FROM __temp__films');
        $this->addSql('DROP TABLE __temp__films');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, roles, password, age FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, age INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, username, roles, password, age) SELECT id, username, roles, password, age FROM __temp__user');
